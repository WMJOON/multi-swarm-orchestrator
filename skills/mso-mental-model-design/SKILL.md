...
### Phase 4) 산출물 저장
- `outputs/mental_model_bundle.json`에 기록.
...
- `python3 scripts/build_bundle.py --topology outputs/workflow_topology_spec.json --output outputs/mental_model_bundle.json`
