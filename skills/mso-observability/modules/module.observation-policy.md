...
- 실행 산출물: `{workspace}/.mso-context/active/<run_id>/30_execution/execution_plan.json`
...
## 출력
- 각 신호는 `{workspace}/.mso-context/active/<run_id>/60_observability/signal_inventory.json`에 집계 후 callback 생성.
