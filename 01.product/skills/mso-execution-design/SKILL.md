...
| 상황 | 파일 |
|------|------|
| 실행계획 생성 | `python3 scripts/build_plan.py --topology workspace/.mso-context/active/<Run ID>/10_topology/workflow_topology_spec.json --bundle workspace/.mso-context/active/<Run ID>/20_mental-model/mental_model_bundle.json --output workspace/.mso-context/active/<Run ID>/30_execution/execution_plan.json` |
