...
### Execution Command
```bash
python3 "<path-removed> Documents/iCloud~md~obsidian/Documents/wmjoon/skills/skills/ai-collaborator/scripts/collaborate.py" --provider [codex|claude|gemini|grok] --message "[Your Prompt]"
```
