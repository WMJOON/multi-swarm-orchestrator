...
> CC-01~CC-14 계약 검증, 구조 검사, 레거시 참조 탐지를 수행한다.
...
| 개념 | 정의 |
|------|------|
| **CC (Contract Coupling)** | 스킬 간 입출력 계약. CC-01~CC-14로 정의 |
...
2. CC-01~CC-14 각각에 대해:
   ...
   - CC-11(optimizer → model-optimizer): Tier Escalation 미발생 시 warn 처리
